...
//
//    @Autowired
//    private DiscussPostMapper discussPostMapper;//从mysql数据库取数据使用
//
//    @Autowired
//    private DiscussPostRepository discussRepository;//往elasticsearch操作数据
//
//    @Autowired
//    @Qualifier("client")//用client注入bean
